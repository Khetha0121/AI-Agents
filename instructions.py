...
4. IMPORTANT: Only base your output on the provided input. Do NOT invent information or assume market context that isn't clearly stated.
...
4. Limit each variation to no more than 30 words.
...
5. Before finalizing, double-check that all information is copied accurately from state inputs. Do not invent or add any new information.
